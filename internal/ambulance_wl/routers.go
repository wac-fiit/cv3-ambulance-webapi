	...
	return []Route{ 
		{
			"GetConditions",
			http.MethodGet,
			"/cv3-api/waiting-list/:ambulanceId/condition",
			handleFunctions.AmbulanceConditionsAPI.GetConditions,
		},
		{
			"CreateWaitingListEntry",
			http.MethodPost,
			"/cv3-api/waiting-list/:ambulanceId/entries",
			handleFunctions.AmbulanceWaitingListAPI.CreateWaitingListEntry,
		},
		{
			"DeleteWaitingListEntry",
			http.MethodDelete,
			"/cv3-api/waiting-list/:ambulanceId/entries/:entryId",
